document.addEventListener("DOMContentLoaded", () => {
    ...
    function getWindDirection(degrees) {
      ...
      console.log(directions[normalizedIndex]);
    ...
    function displayWeatherData(data) {
      ...
      weatherHTML.innerHTML = `
          ...
          <p class="wind">Wind Speed : ${Math.round(data.wind.speed*3.6)}kmph</p>
          <p class="humidity">Humidity : ${data.main.humidity}%</p>
          <p class="time">Time Zone : GMT +5:30</p>
          <p class="pressure">Pressure: ${Math.round(data.main.pressure * 0.000987)}atm</p>
          <p class="windDir">Wind Direction : ${getWindDirection(data.wind.deg)}</p>
